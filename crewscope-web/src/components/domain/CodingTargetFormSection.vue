...
<style scoped>
.coding-target { margin: var(--cs-space-16) var(--cs-space-20) 0; overflow: hidden; border: 1px solid var(--cs-border); border-radius: var(--cs-radius-md); background: linear-gradient(145deg, var(--cs-surface) 0%, var(--cs-surface-accent) 100%); }.coding-target > header { display: grid; grid-template-columns: 34px minmax(0, 1fr) auto; align-items: center; gap: var(--cs-space-8); padding: var(--cs-space-12) var(--cs-space-12); border-bottom: 1px solid var(--cs-border); }.coding-target > header > span { display: grid; width: 34px; height: 34px; place-items: center; border-radius: 10px; background: var(--cs-surface-accent-strong); color: var(--cs-text-brand); }.coding-target strong, .coding-target small { display: block; }.coding-target strong { font-size: var(--cs-text-sm); }.coding-target small { margin-top: var(--cs-space-2); color: var(--cs-text-muted); font-size: var(--cs-text-xs); font-weight: var(--cs-weight-medium); }.coding-switch { display: flex; align-items: center; gap: var(--cs-space-8); color: var(--cs-text-secondary); font-size: var(--cs-text-xs); font-weight: var(--cs-weight-semibold); cursor: pointer; }.coding-switch input { accent-color: var(--cs-focus); }.coding-note, .coding-state { min-height: 52px; margin: 0; padding: var(--cs-space-16); color: var(--cs-text-muted); font-size: var(--cs-text-xs); line-height: var(--cs-leading-normal); }.coding-state { display: flex; align-items: center; justify-content: center; gap: var(--cs-space-8); }.coding-state.error { color: var(--cs-danger); }.coding-state.empty { flex-wrap: wrap; background: var(--cs-warning-soft); color: var(--cs-warning); }.coding-state a { color: inherit; font-weight: var(--cs-weight-semibold); }.coding-fields { display: grid; grid-template-columns: 1fr 1fr; gap: var(--cs-space-12); padding: var(--cs-space-12); }.coding-fields label { display: grid; min-width: 0; gap: var(--cs-space-4); color: var(--cs-text-secondary); font-size: var(--cs-text-xs); font-weight: var(--cs-weight-semibold); }.coding-fields label > span { display: flex; align-items: baseline; gap: var(--cs-space-4); }.coding-fields label small { display: inline; }.coding-fields input, .coding-fields select, .coding-fields textarea { width: 100%; min-height: 35px; padding: var(--cs-space-8) var(--cs-space-8); border: 1px solid var(--cs-border-strong); border-radius: var(--cs-radius-sm); background: var(--cs-surface); color: var(--cs-text); font: var(--cs-text-base)/var(--cs-leading-normal) var(--cs-font-sans); }.coding-fields textarea { resize: vertical; }.coding-fields [aria-invalid="true"] { border-color: var(--cs-danger); }.wide { grid-column: 1 / -1; }.ref-field { position: relative; }.ref-field svg { position: absolute; top: 10px; left: 9px; color: var(--cs-text-muted); }.ref-field input { padding-left: var(--cs-space-32); }.preflight-row { display: flex; min-height: 34px; align-items: center; gap: var(--cs-space-8); color: var(--cs-text-muted); font-size: var(--cs-text-xs); }.preflight-row > span { display: flex; min-width: 0; align-items: center; gap: var(--cs-space-4); }.preflight-ok { color: var(--cs-success); }.preflight-error, .field-error { color: var(--cs-danger); }.preflight-row code { font-size: var(--cs-text-xs); }.field-error { margin: calc(var(--cs-space-4) * -1) 0 0; font-size: var(--cs-text-xs); }.spin { animation: spin var(--cs-motion-spin) linear infinite; }@keyframes spin { to { transform: rotate(360deg); } }
@media (max-width: 600px) { .coding-target { margin-inline: var(--cs-space-16); }.coding-target > header { grid-template-columns: 34px minmax(0, 1fr); }.coding-switch { grid-column: 2; }.coding-fields { grid-template-columns: 1fr; padding: var(--cs-space-12); }.wide { grid-column: 1; }.preflight-row { align-items: stretch; flex-direction: column; }.preflight-row > button { width: 100%; }.preflight-row > span { min-height: 28px; }.coding-state { align-items: flex-start; flex-direction: column; } }
.coding-header { display: grid; grid-template-columns: 34px minmax(0, 1fr) auto; align-items: center; gap: var(--cs-space-8); padding: var(--cs-space-12) var(--cs-space-12); border-bottom: 1px solid var(--cs-border); }.coding-header > span { display: grid; width: 34px; height: 34px; place-items: center; border-radius: 10px; background: var(--cs-surface-accent-strong); color: var(--cs-text-brand); }
