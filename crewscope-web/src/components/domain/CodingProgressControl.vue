...
import { codingTodoStatusLabels } from '../../domains/coding/labels'
...
/** Plan todo status arrives as `CodingTodoStatus.name()`, so it is read through the label map. */
      ...
      <section class="progress-facts" aria-labelledby="coding-todo-title">
        ...
        <ul v-if="orderedTodos.length" class="coding-todos">
          <li v-for="todo in orderedTodos" :key="`${todo.planStepKey}:${todo.content}`">
            <StatusBadge :tone="todoTone(todo)">{{ label(todo.status, codingTodoStatusLabels) }}</StatusBadge>
...
<style scoped>
.coding-progress{border-top: 1px solid var(--cs-border);background: var(--cs-surface)}.progress-heading{display:flex;align-items:center;justify-content:space-between;gap:var(--cs-space-12);padding:var(--cs-space-12) var(--cs-space-16)}.progress-heading p,.progress-heading h4{margin:0}.progress-heading p{color: var(--cs-text-brand);font-size:var(--cs-text-xs);font-weight:var(--cs-weight-semibold);letter-spacing:.08em;text-transform:uppercase}.progress-heading h4{margin-top:var(--cs-space-2);font-size:var(--cs-text-base)}.stage-rail{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));margin:0;padding:0 var(--cs-space-16) var(--cs-space-8);list-style:none}.stage-rail li{position:relative;display:grid;min-width:0;grid-template-columns:auto minmax(0,1fr);align-items:center;gap:var(--cs-space-8);padding:var(--cs-space-8) var(--cs-space-8);border-block: 1px solid var(--cs-border);background: var(--cs-surface-subtle);color: var(--cs-text-muted)}.stage-rail li:first-child{border-left: 1px solid var(--cs-border);border-radius:8px 0 0 8px}.stage-rail li:last-child{border-right: 1px solid var(--cs-border);border-radius:0 8px 8px 0}.stage-rail li+li:before{position:absolute;left:0;width:1px;height:64%;background: var(--cs-border);content:""}.stage-rail svg{flex:0 0 auto}.stage-rail span,.stage-rail strong,.stage-rail small{display:block;min-width:0}.stage-rail strong,.stage-rail small{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.stage-rail strong{font-size:var(--cs-text-xs)}.stage-rail small{margin-top:var(--cs-space-2);font:var(--cs-text-xs) var(--cs-font-mono)}.stage-completed{color: var(--cs-success)!important;background: var(--cs-surface-accent)!important}.stage-active{color: var(--cs-text-brand)!important;background: var(--cs-surface-accent)!important}.stage-interrupted{color: var(--cs-danger)!important;background: var(--cs-danger-soft)!important}.stage-note{margin:0;padding:0 var(--cs-space-16) var(--cs-space-8);color: var(--cs-text-muted);font-size:var(--cs-text-xs);line-height:var(--cs-leading-normal)}.progress-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:var(--cs-space-8);padding:0 var(--cs-space-16) var(--cs-space-16)}.progress-facts,.control-slot{min-width:0;border: 1px solid var(--cs-border);border-radius:9px;background: var(--cs-surface-subtle)}.progress-facts{padding:var(--cs-space-12)}.progress-facts>header{display:flex;align-items:center;gap:var(--cs-space-8);min-height:20px;color: var(--cs-text-secondary);font-size:var(--cs-text-xs)}.progress-facts>header svg{color: var(--cs-text-brand)}.progress-facts>header small,.progress-facts>header :deep(.status-badge){margin-left:auto}.progress-facts>p{margin:var(--cs-space-8) 0 0;color: var(--cs-text-muted);font-size:var(--cs-text-xs);line-height:var(--cs-leading-normal)}.coding-todos{display:grid;gap:var(--cs-space-4);margin:var(--cs-space-8) 0 0;padding:0;list-style:none}.coding-todos li{display:grid;grid-template-columns:auto minmax(0,1fr);align-items:start;gap:var(--cs-space-8);padding:var(--cs-space-8);border-radius:7px;background: var(--cs-surface)}.coding-todos span,.coding-todos strong,.coding-todos small{display:block;min-width:0}.coding-todos strong{font-size:var(--cs-text-xs)}.coding-todos small{margin-top:var(--cs-space-2);color: var(--cs-text-muted);font:var(--cs-text-xs) var(--cs-font-mono)}.checkpoint-grid{display:grid;grid-template-columns:1fr 1fr;gap:var(--cs-space-8);margin:var(--cs-space-8) 0 0}.checkpoint-grid>div{min-width:0;padding:var(--cs-space-8);border-radius:7px;background: var(--cs-surface)}.checkpoint-grid dt{color: var(--cs-text-muted);font-size:var(--cs-text-xs)}.checkpoint-grid dd{margin:var(--cs-space-4) 0 0;overflow:hidden;font:var(--cs-text-xs) var(--cs-font-mono);text-overflow:ellipsis;white-space:nowrap}.checkpoint-warning{display:flex;align-items:flex-start;gap:var(--cs-space-4);color: var(--cs-warning)!important}.repair-meter{display:grid;grid-template-columns:1fr 1fr;gap:var(--cs-space-8);margin-top:var(--cs-space-8)}.repair-meter>div{padding:var(--cs-space-8);border-radius:7px;background: var(--cs-surface)}.repair-meter span,.repair-meter strong{display:block}.repair-meter span{color: var(--cs-text-muted);font-size:var(--cs-text-xs)}.repair-meter strong{margin-top:var(--cs-space-2);font:var(--cs-text-sm) var(--cs-font-mono)}.repair-disclosure{padding-top:var(--cs-space-8);border-top: 1px solid var(--cs-border)}.control-slot{background: linear-gradient(145deg,var(--cs-surface-accent),var(--cs-surface) 72%)}.control-slot :deep(.task-control-panel){height:100%;border: 0;background: transparent}.history-control-note{display:flex;min-height:100%;align-items:flex-start;gap:var(--cs-space-8);padding:var(--cs-space-16);color: var(--cs-text-muted);font-size:var(--cs-text-xs);line-height:var(--cs-leading-normal)}.history-control-note svg{flex:0 0 auto;color: var(--cs-text-brand)}.history-control-note strong{display:block;margin-bottom:var(--cs-space-2);color: var(--cs-text-secondary);font-size:var(--cs-text-xs)}@media(max-width:720px){.stage-rail{grid-template-columns:1fr}.stage-rail li{border: 1px solid var(--cs-border);border-radius:0!important}.stage-rail li:first-child{border-radius:8px 8px 0 0!important}.stage-rail li:last-child{border-radius:0 0 8px 8px!important}.stage-rail li+li{border-top: 0}.stage-rail li+li:before{display:none}.progress-grid{grid-template-columns:1fr}.progress-facts--test{order:3}.control-slot{order:4}.checkpoint-grid{grid-template-columns:1fr 1fr}}
</style>
