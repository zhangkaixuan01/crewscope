...
<style scoped>
.timeline { display: grid; }.timeline-state { margin: 0; padding: var(--cs-space-12); border-radius: 8px; background: var(--cs-surface-subtle); color: var(--cs-text-muted); font-size: var(--cs-text-xs); }.timeline-state.error, .timeline-more-error { color: var(--cs-danger); }.timeline ol { display: grid; gap: 0; padding: 0; margin: 0; list-style: none; }.timeline li { position: relative; display: grid; grid-template-columns: 28px minmax(0, 1fr); gap: var(--cs-space-8); min-height: 54px; }.timeline li:not(:last-child)::before { position: absolute; top: 27px; bottom: 0; left: 13px; width: 1px; background: var(--cs-border); content: ''; }.timeline li > i { z-index: 1; display: grid; width: 28px; height: 28px; place-items: center; border: 1px solid var(--cs-border); border-radius: 50%; background: var(--cs-surface-accent); color: var(--cs-text-brand); font-style: normal; }.timeline li > i.agent { background: var(--cs-agent-soft); color: var(--cs-agent); }.timeline header { display: flex; align-items: baseline; justify-content: space-between; gap: var(--cs-space-8); }.timeline header strong { font-size: var(--cs-text-sm); }.timeline time { color: var(--cs-text-muted); font-size: var(--cs-text-xs); white-space: nowrap; }.timeline li p { display: flex; align-items: center; gap: var(--cs-space-8); margin: var(--cs-space-4) 0 0; color: var(--cs-text-muted); font-size: var(--cs-text-xs); }.timeline li p svg { color: var(--cs-success); }.timeline-more-error { margin: var(--cs-space-4) 0 var(--cs-space-8); font-size: var(--cs-text-xs); }.timeline > button { justify-self: center; margin-top: var(--cs-space-4); }
</style>
