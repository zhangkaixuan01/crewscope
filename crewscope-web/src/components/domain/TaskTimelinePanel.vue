...
<style scoped>
.timeline-card { padding: var(--cs-space-16); }.timeline-heading { display: flex; align-items: center; justify-content: space-between; gap: var(--cs-space-12); margin-bottom: var(--cs-space-12); }.timeline-heading p { margin: 0 0 var(--cs-space-2); color: var(--cs-text-brand); font-size: var(--cs-text-xs); font-weight: var(--cs-weight-semibold); letter-spacing: .08em; text-transform: uppercase; }.timeline-heading h3 { margin: 0; font-size: var(--cs-text-base); }.timeline-heading h3 span { color: var(--cs-text-muted); font-weight: var(--cs-weight-medium); }.timeline-state { margin-bottom: var(--cs-space-8); }.progress-card { margin-bottom: var(--cs-space-12); padding: var(--cs-space-12); border: 1px solid var(--cs-border-accent); border-radius: 10px; background: var(--cs-surface-accent); }.progress-card > div:first-child { display: flex; align-items: center; justify-content: space-between; gap: var(--cs-space-8); }.progress-card span { color: var(--cs-text-brand); font-size: var(--cs-text-xs); font-weight: var(--cs-weight-semibold); }.progress-card strong { color: var(--cs-text-brand); font-size: var(--cs-text-base); }.progress-track { height: 5px; margin-top: var(--cs-space-8); overflow: hidden; border-radius: 999px; background: var(--cs-surface-accent-strong); }.progress-fill { display: block; height: 100%; border-radius: inherit; background: var(--cs-brand-600); transition: width var(--cs-motion-slow) var(--cs-ease-out); }.progress-card p { margin: var(--cs-space-8) 0 0; color: var(--cs-text-secondary); font-size: var(--cs-text-xs); line-height: var(--cs-leading-normal); }.timeline-list { display: grid; }.timeline-list article { position: relative; display: grid; grid-template-columns: 24px minmax(0, 1fr) auto; align-items: start; gap: var(--cs-space-8); padding: var(--cs-space-8) 0; border-top: 1px solid var(--cs-border); }.timeline-list article > i { display: grid; width: 24px; height: 24px; place-items: center; border-radius: 50%; background: var(--cs-surface-subtle); color: var(--cs-text-muted); }.timeline-list article.recovery > i { background: var(--cs-warning-soft); color: var(--cs-warning); }.timeline-list strong, .timeline-list p, .timeline-list span { display: block; }.timeline-list strong { font-size: var(--cs-text-xs); line-height: var(--cs-leading-normal); }.timeline-list p { margin: var(--cs-space-4) 0 0; color: var(--cs-text-secondary); font-size: var(--cs-text-xs); line-height: var(--cs-leading-normal); }.timeline-list span { margin-top: var(--cs-space-4); color: var(--cs-text-muted); font-size: var(--cs-text-xs); }.empty-note { display: flex; align-items: center; gap: var(--cs-space-8); margin: 0; color: var(--cs-text-muted); font-size: var(--cs-text-xs); }.timeline-more { display: flex; justify-content: center; padding-top: var(--cs-space-8); border-top: 1px solid var(--cs-border); }.timeline-error { display: flex; align-items: center; gap: var(--cs-space-4); margin: var(--cs-space-8) 0 0; color: var(--cs-danger); font-size: var(--cs-text-xs); }.timeline-error button { display: inline-flex; align-items: center; gap: var(--cs-space-4); color: inherit; text-decoration: underline; cursor: pointer; }.sr-only { position: absolute; width: 1px; height: 1px; overflow: hidden; clip: rect(0, 0, 0, 0); white-space: nowrap; clip-path: inset(50%); }
