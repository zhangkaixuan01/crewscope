...
withDefaults(defineProps<{ modelValue?: boolean; disabled?: boolean; label?: string }>(), { modelValue: false, disabled: false, label: '' })
...
.base-switch button:disabled { cursor: not-allowed; opacity: .6; }
</style>
