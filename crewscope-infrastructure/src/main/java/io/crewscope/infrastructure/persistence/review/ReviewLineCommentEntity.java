...
public class ReviewLineCommentEntity {
    ...
    /** The newest update command key; the create key above never changes after insert. */
    @Column(name = "last_command_idempotency_key", length = 200) private String lastCommandIdempotencyKey;
    ...
    public ReviewLineCommentEntity(UUID id, UUID organizationId, UUID teamId, UUID workspaceId,
            ...
            boolean deleted, long version, String idempotencyKey, String lastCommandIdempotencyKey,
        ...
        this.deleted=deleted; this.version=version; this.idempotencyKey=idempotencyKey;
        this.lastCommandIdempotencyKey=lastCommandIdempotencyKey; this.createdAt=createdAt;
    ...
    String lastCommandIdempotencyKey(){return lastCommandIdempotencyKey;}
