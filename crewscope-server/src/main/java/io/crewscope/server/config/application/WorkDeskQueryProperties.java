...
/** Signed-cursor policy for the M9b-A06 WorkDesk section continuations. */
@ConfigurationProperties(prefix = "crewscope.work-desk")
public class WorkDeskQueryProperties {
