...
> 当前进度：M0、M1、M2、M3 已完成；M4-S01 至 M4-S04、M4-D01 至 M4-D09、M4-I01 至 M4-I12 已完成，下一项为 M4-A01（2026-08-19）
...
M4 已拆分为 44 个可执行任务，在 M3 执行内核上交付 RepositoryBinding、CodingTargetSnapshot、ExecutionWorkspace、Git Worktree、Docker Sandbox、受控代码工具、Coding Specialist、DiffArtifact、TestEvidence、Repository 管理与 Execution Studio。`M4-S01` 至 `M4-S04`、`M4-D01` 至 `M4-D09`、`M4-I01` 至 `M4-I12` 已完成，下一项为 `M4-A01`。M4-I01 至 I10 已完成 Git、Workspace、Sandbox、受控 Tool、Diff、Artifact 与启动恢复基础设施；M4-I11 已完成固定 Skill/Tool 面的原生 Coding Specialist、Plan/Todo、Compaction、Eviction、AgentState 安全点与严格输出；M4-I12 已完成 Specialist Step 协调、策略修复预算、事件优先 Checkpoint、Pause/Resume/Cancel、Snapshot/Workspace 恢复、权威结果复验与终态映射。验证见 [M4-I10 Worker 启动资源对账](testing/M4-I10-Worker启动资源对账.md)、[M4-I11 AgentScope Coding Specialist 运行时](testing/M4-I11-AgentScope-Coding-Specialist运行时.md)与 [M4-I12 Coding Specialist Step 执行与恢复](testing/M4-I12-Coding-Specialist-Step执行与恢复.md)。
