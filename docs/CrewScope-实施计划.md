...
建议周期以 2 名后端与 1 名前端小组为基准，M0–M6 用 18–24 周交付 Team Beta，M7 追加 3–4 周完成开放用户入口，M8 使用 5–7 周完成产品化与工程收口。单人实施按 M0 到 M8 串行推进，M8 可按“配置闭环”和“工程生产收口”两条线交错执行。生产级 Kubernetes 执行拓扑、Vault/KMS 高可用、企业身份、容灾和长期 SLO 加固单独排期。
