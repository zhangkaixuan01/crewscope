...
public final class TeamCreationService {
    ...
    /**
     * Creates and persists Team, default Workspace, owner Membership, built-in roles, owner grant
     * and the owner's default Personal Agent. Authentication adapters must supply the
     * server-resolved creator Principal.
     */
    public TeamInitialization create(Principal creator, CreateTeamCommand command) {
        ...
        return transactionExecutor.required(() -> persist(TeamInitialization.create(
    ...
    private TeamInitialization persist(TeamInitialization initialization) {
        ...
        Team team = teamRepository.create(initialization.team());
        ...
        PersonalAgentInitialization personalAgent = Objects.requireNonNull(
