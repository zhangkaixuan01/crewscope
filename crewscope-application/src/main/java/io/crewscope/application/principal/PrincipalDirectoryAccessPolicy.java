...
/** Reuses the existing Team membership authority for subject directory reads. */
public final class PrincipalDirectoryAccessPolicy {
    private final WorkItemAccessPolicy accessPolicy;

    public PrincipalDirectoryAccessPolicy(WorkItemAccessPolicy accessPolicy) {
        this.accessPolicy = Objects.requireNonNull(accessPolicy, "accessPolicy");
    }

    public TeamMember requireMember(
