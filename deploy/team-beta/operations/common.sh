...
load_operator_environment() {
  ...
  CREWSCOPE_RESTORE_MAX_SCHEMA=${CREWSCOPE_RESTORE_MAX_SCHEMA:-36}
  CREWSCOPE_RESTORE_TARGET_SCHEMA=${CREWSCOPE_RESTORE_TARGET_SCHEMA:-36}
  ...
  [ "$CREWSCOPE_RESTORE_MIN_SCHEMA" = 26 ] \
    ...
    || fail "Team Beta recovery boundary is frozen at V26..V36 -> V36"
